...
class SupsysticTables_Core_Module extends SupsysticTables_Core_BaseModule
{
    ...
    public function afterUiLoaded(SupsysticTables_Ui_Module $ui)
    {
		...
		add_action(is_admin() ? $hookName : 'wp_enqueue_scripts', array($this, 'addLanguagesData'), 999);
		add_action(is_admin() ? $hookName : 'wp_enqueue_scripts', array($this, 'addCommonPluginData'), 999);
        $ui->add(
